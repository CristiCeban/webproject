...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 07 2020 г., 21:07
...
--
-- База данных: `2019_projet5_services`
--

-- --------------------------------------------------------

--
-- Структура таблицы `affectations`
--
...
--
-- Дамп данных таблицы `affectations`
--
...
--
-- Дамп данных таблицы `enseignants`
--
...
--
-- AUTO_INCREMENT для таблицы `enseignants`
--
ALTER TABLE `enseignants`
  MODIFY `eid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `etypes`
--
ALTER TABLE `etypes`
...
--
-- AUTO_INCREMENT для таблицы `gtypes`
--
ALTER TABLE `gtypes`
...
--
-- Ограничения внешнего ключа таблицы `affectations`
--
ALTER TABLE `affectations`
...
--
-- Ограничения внешнего ключа таблицы `enseignants`
--
ALTER TABLE `enseignants`
